...
struct handlesS {
    ...
    icmNetP              cpu2_irq0_n;
    icmNetP              cpu2_irq1_n;
    icmNetP              fprint_write_2_n;
    icmNetP              fprint_write_address_2_n;
    icmNetP              fprint_write_data_2_n;
    icmNetP              cpu3_irq4_n;
    icmNetP              cpu3_irq0_n;
    icmNetP              cpu3_irq1_n;
    icmNetP              fprint_write_3_n;
    icmNetP              fprint_write_address_3_n;
    icmNetP              fprint_write_data_3_n;
    icmNetP              cpum_irq4_n;
    icmNetP              cpum_irq0_n;
    icmNetP              cpum_irq1_n;
    icmNetP              cpum_irq5_n;
