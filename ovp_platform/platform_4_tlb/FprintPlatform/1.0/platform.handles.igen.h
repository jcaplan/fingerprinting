...
struct handlesS {
    ...
    icmBusP              cpu2_iobus_b;
    icmBusP              cpu2_tlbbus_b;
    icmBusP              cpu2_tlbbus_in_b;
    icmBusP              cpu2_dbus_b;
    icmBusP              cpu2_ibus_b;
    icmBusP              cpu2_tlb_fprint_bus_b;
    icmBusP              cpu3_iobus_b;
    icmBusP              cpu3_tlbbus_b;
    icmBusP              cpu3_tlbbus_in_b;
    icmBusP              cpu3_dbus_b;
    icmBusP              cpu3_ibus_b;
    icmBusP              cpu3_tlb_fprint_bus_b;
    icmBusP              cpum_iobus_b;
    icmBusP              cpum_dbus_b;
    icmBusP              cpum_ibus_b;
    icmBusP              cpu0_dmabus_b;
    icmBusP              cpu1_dmabus_b;
    icmBusP              cpu2_dmabus_b;
    icmBusP              cpu3_dmabus_b;
    icmBusP              compbus_b;
    ...
    icmMemoryP           cpu2_breakmem_m;
    icmMemoryP           cpu2_scratchpad_m;
    icmMemoryP           cpu3_breakmem_m;
    icmMemoryP           cpu3_scratchpad_m;
    ...
    icmPseP              cpu2_tlb_p;
    icmPseP              cpu2_jtag_uart_p;
    icmPseP              cpu2_timer_10ms_p;
    icmPseP              cpu2_timestamp_p;
    icmPseP              cpu2_fprint_p;
    icmPseP              cpu3_tlb_p;
    icmPseP              cpu3_jtag_uart_p;
    icmPseP              cpu3_timer_10ms_p;
    icmPseP              cpu3_timestamp_p;
    icmPseP              cpu3_fprint_p;
    ...
    icmNetP              cpu2_reset1_n;
    icmNetP              cpu3_reset1_n;
} handles;
