...
mkram main_memory     mmbus          0x00000000 0x000F9FFF
...
ihwconnect 	 -instancename cpu0_mm_out_bridge -busslaveport  sp1 -bus cpu0_tlbbus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpu0_mm_out_bridge -busmasterport mp1 -bus mmbus        -loaddress 0x00000000 -hiaddress 0x000F9FFF
...
isetattribute    -handle       cpu0_timer_10ms -name timeoutPeriod   -value 50000 
...
ihwconnect 	 -instancename cpu1_mm_out_bridge -busslaveport  sp1 -bus cpu1_tlbbus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpu1_mm_out_bridge -busmasterport mp1 -bus mmbus        -loaddress 0x00000000 -hiaddress 0x000F9FFF
...
isetattribute    -handle       cpu1_timer_10ms -name timeoutPeriod   -value 50000 
...
define CPU2_HARDWARE_DIVIDE_PRESENT 1
define CPU2_HARDWARE_MULTIPLY_PRESENT 1
define CPU2_HARDWARE_MULX_PRESENT 1
...
isetattribute -handle cpu2 -name INCLUDE_MPU 					 -value 1
isetattribute -handle cpu2 -name MPU_USE_LIMIT_FOR_REGION_RANGE  -value 1
isetattribute -handle cpu2 -name MPU_NUMBER_DATA_REGIONS         -value 16
isetattribute -handle cpu2 -name MPU_MINIMUM_DATA_REGION_SIZE    -value 64
isetattribute -handle cpu2 -name MPU_NUMBER_INSTRUCTION_REGIONS  -value 8
isetattribute -handle cpu2 -name MPU_MINIMUM_INSTRUCTION_REGION_SIZE -value 64
isetattribute -handle cpu2 -name EXCEPTION_EXTRA_INFORMATION 	 -value 1


ihwaddbus -instancename cpu2_iobus -addresswidth 32
ihwaddbus -instancename cpu2_tlbbus -addresswidth 32
ihwaddbus -instancename cpu2_tlbbus_in -addresswidth 32
...
ihwaddperipheral -instancename cpu2_tlb    -vendor mcgill.ca -type tlb -version 1.0 -diagnosticlevel 3
ihwconnect       -instancename cpu2_tlb    -bus cpu2_tlbbus    -busmasterport TLB_MASTER -loaddress 0x0000000 -hiaddress 0xFFFFFFFF
ihwconnect       -instancename cpu2_tlb    -bus cpu2_tlbbus_in -busslaveport  TLB_SLAVE  
...
ihwaddbridge -instancename cpu2_d_bridge
ihwconnect   -instancename cpu2_d_bridge -busslaveport  sp1 -bus cpu2_dbus        -loaddress 0x00000000 -hiaddress 0xFFFFFFFF
ihwconnect   -instancename cpu2_d_bridge -busmasterport mp1 -bus cpu2_tlbbus_in   -loaddress 0x00000000 -hiaddress 0xFFFFFFFF

ihwaddbridge -instancename cpu2_i_bridge
ihwconnect   -instancename cpu2_i_bridge -busslaveport  sp1 -bus cpu2_ibus       -loaddress 0x00000000 -hiaddress 0xFFFFFFFF
ihwconnect   -instancename cpu2_i_bridge -busmasterport mp1 -bus cpu2_tlbbus_in  -loaddress 0x00000000 -hiaddress 0xFFFFFFFF


ihwaddbridge -instancename cpu2_out_bridge
ihwconnect   -instancename cpu2_out_bridge -busslaveport  sp1 -bus cpu2_tlbbus  -loaddress 0x02500000 -hiaddress 0x025003FF
ihwconnect   -instancename cpu2_out_bridge -busmasterport mp1 -bus smbus -loaddress 0x00000000 -hiaddress 0x000003FF

ihwaddbridge -instancename cpu2_mm_out_bridge
ihwconnect 	 -instancename cpu2_mm_out_bridge -busslaveport  sp1 -bus cpu2_tlbbus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpu2_mm_out_bridge -busmasterport mp1 -bus mmbus        -loaddress 0x00000000 -hiaddress 0x000F9FFF

ihwaddbridge -instancename cpu2_mutex
ihwconnect 	 -instancename cpu2_mutex -busslaveport  sp1 -bus cpu2_tlbbus  -loaddress 0x02300000 -hiaddress 0x02300007
...
ihwconnect 	 -instancename cpu2_irq_bridge -busslaveport  sp1 -bus cpu2_tlbbus   -loaddress 0x02200000 -hiaddress 0x022023FF
...
ihwconnect 	 -instancename cpu2_flash_bridge -busslaveport  sp1 -bus cpu2_tlbbus   -loaddress 0x00000000 -hiaddress 0x003FFFFF
...
#
#proc mkram { name bus lo hi }
mkram cpu2_breakmem     cpu2_iobus     0x00008020 0x00008100
mkram cpu2_scratchpad   cpu2_tlbbus     0x04200000 0x04207FFF

# IO bus bridgepb_cpu_to_io 0x0800_0000 0x087F_FFFF
#
ihwaddbridge -instancename cpu2_local_bridge
ihwconnect   -instancename cpu2_local_bridge -busslaveport  sp1 -bus cpu2_tlbbus  -loaddress 0x08000000 -hiaddress 0x087FFFFF
ihwconnect   -instancename cpu2_local_bridge -busmasterport mp1 -bus cpu2_iobus -loaddress 0x00000000 -hiaddress 0x007FFFFF 


ihwconnect       -instancename cpu2_tlb    -bus cpu2_iobus -busslaveport TLB_CSR -loaddress 0x00300000 -hiaddress 0x003003FF
...
isetattribute    -handle       cpu2_timer_10ms -name timeoutPeriod   -value 50000 
...
# 0x00400000 - 0x00400017 timestamp
ihwaddperipheral -instancename cpu2_timestamp -vendor mcgill.ca -type IntervalTimer64Core -diagnosticlevel 0
ihwconnect       -instancename cpu2_timestamp -bus cpu2_iobus -busslaveport sp1 -loaddress 0x00000000 -hiaddress 0x00000027
isetattribute    -handle       cpu2_timestamp -name timerFrequency  -value 50000000
isetattribute    -handle       cpu2_timestamp -name timeoutPeriod   -value 50000
...
# FPRINT
#
ihwaddperipheral -instancename cpu2_fprint -vendor mcgill.ca -type fprint -version 3.0 -diagnosticlevel 0
ihwconnect       -instancename cpu2_fprint    -bus cpu2_iobus -busslaveport FPRINT_CSR_SLAVE -loaddress 0x0100000 -hiaddress 0x010013F
isetattribute    -handle       cpu2_fprint -name coreID  -value 0


ihwconnect       -instancename cpu2_fprint    -netport FPRINT_WRITE              -net fprint_write_0
ihwconnect       -instancename cpu2           -netport fprint_write_out          -net fprint_write_0

ihwconnect       -instancename cpu2_fprint    -netport FPRINT_WRITE_ADDRESS      -net fprint_write_address_0
ihwconnect       -instancename cpu2           -netport fprint_write_out_address  -net fprint_write_address_0

ihwconnect       -instancename cpu2_fprint    -netport FPRINT_WRITE_DATA         -net fprint_write_data_0
ihwconnect       -instancename cpu2           -netport fprint_write_out_data     -net fprint_write_data_0

ihwaddbus 		 -instancename cpu2_tlb_fprint_bus   -addresswidth 32
ihwconnect       -instancename cpu2_tlb    -bus cpu2_tlb_fprint_bus    -busmasterport TLB_FPRINT_MASTER -loaddress 0x0000000 -hiaddress 0x07FFFFFF
ihwconnect       -instancename cpu2_fprint -bus cpu2_tlb_fprint_bus    -busslaveport  FPRINT_TLB_SLAVE  -loaddress 0x000000  -hiaddress 0x000003FF


# SW_RESET
ihwconnect       -instancename sw_reset        -netport cpu2_reset   -net cpu2_reset1
# ihwconnect       -instancename cpu2            -netport reset_n      -net cpu2_reset1
ihwconnect 		 -instancename cpu2_fprint 	   -netport FPRINT_RESET -net cpu2_reset1;
# ihwconnect 		 -instancename cpu2_tlb 	   -netport TLB_RESET    -net cpu2_reset1;
...
define CPU3_HARDWARE_DIVIDE_PRESENT 1
define CPU3_HARDWARE_MULTIPLY_PRESENT 1
define CPU3_HARDWARE_MULX_PRESENT 1
...
isetattribute -handle cpu3 -name INCLUDE_MPU 					 -value 1
isetattribute -handle cpu3 -name MPU_USE_LIMIT_FOR_REGION_RANGE  -value 1
isetattribute -handle cpu3 -name MPU_NUMBER_DATA_REGIONS         -value 16
isetattribute -handle cpu3 -name MPU_MINIMUM_DATA_REGION_SIZE    -value 64
isetattribute -handle cpu3 -name MPU_NUMBER_INSTRUCTION_REGIONS  -value 8
isetattribute -handle cpu3 -name MPU_MINIMUM_INSTRUCTION_REGION_SIZE -value 64
isetattribute -handle cpu3 -name EXCEPTION_EXTRA_INFORMATION 	 -value 1


ihwaddbus -instancename cpu3_iobus -addresswidth 32
ihwaddbus -instancename cpu3_tlbbus -addresswidth 32
ihwaddbus -instancename cpu3_tlbbus_in -addresswidth 32
...
ihwaddperipheral -instancename cpu3_tlb    -vendor mcgill.ca -type tlb -version 1.0 -diagnosticlevel 3
ihwconnect       -instancename cpu3_tlb    -bus cpu3_tlbbus    -busmasterport TLB_MASTER -loaddress 0x0000000 -hiaddress 0xFFFFFFFF
ihwconnect       -instancename cpu3_tlb    -bus cpu3_tlbbus_in -busslaveport  TLB_SLAVE  
...
ihwaddbridge -instancename cpu3_d_bridge
ihwconnect   -instancename cpu3_d_bridge -busslaveport  sp1 -bus cpu3_dbus        -loaddress 0x00000000 -hiaddress 0xFFFFFFFF
ihwconnect   -instancename cpu3_d_bridge -busmasterport mp1 -bus cpu3_tlbbus_in   -loaddress 0x00000000 -hiaddress 0xFFFFFFFF

ihwaddbridge -instancename cpu3_i_bridge
ihwconnect   -instancename cpu3_i_bridge -busslaveport  sp1 -bus cpu3_ibus       -loaddress 0x00000000 -hiaddress 0xFFFFFFFF
ihwconnect   -instancename cpu3_i_bridge -busmasterport mp1 -bus cpu3_tlbbus_in  -loaddress 0x00000000 -hiaddress 0xFFFFFFFF


ihwaddbridge -instancename cpu3_out_bridge
ihwconnect   -instancename cpu3_out_bridge -busslaveport  sp1 -bus cpu3_tlbbus  -loaddress 0x02500000 -hiaddress 0x025003FF
ihwconnect   -instancename cpu3_out_bridge -busmasterport mp1 -bus smbus -loaddress 0x00000000 -hiaddress 0x000003FF

ihwaddbridge -instancename cpu3_mm_out_bridge
ihwconnect 	 -instancename cpu3_mm_out_bridge -busslaveport  sp1 -bus cpu3_tlbbus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpu3_mm_out_bridge -busmasterport mp1 -bus mmbus        -loaddress 0x00000000 -hiaddress 0x000F9FFF

ihwaddbridge -instancename cpu3_mutex
ihwconnect 	 -instancename cpu3_mutex -busslaveport  sp1 -bus cpu3_tlbbus  -loaddress 0x02300000 -hiaddress 0x02300007
...
ihwconnect 	 -instancename cpu3_irq_bridge -busslaveport  sp1 -bus cpu3_tlbbus   -loaddress 0x02200000 -hiaddress 0x022023FF
...
ihwconnect 	 -instancename cpu3_flash_bridge -busslaveport  sp1 -bus cpu3_tlbbus   -loaddress 0x00000000 -hiaddress 0x003FFFFF
...
#
#proc mkram { name bus lo hi }
mkram cpu3_breakmem     cpu3_iobus     0x00008020 0x00008100
mkram cpu3_scratchpad   cpu3_tlbbus     0x04200000 0x04207FFF

# IO bus bridgepb_cpu_to_io 0x0800_0000 0x087F_FFFF
#
ihwaddbridge -instancename cpu3_local_bridge
ihwconnect   -instancename cpu3_local_bridge -busslaveport  sp1 -bus cpu3_tlbbus  -loaddress 0x08000000 -hiaddress 0x087FFFFF
ihwconnect   -instancename cpu3_local_bridge -busmasterport mp1 -bus cpu3_iobus -loaddress 0x00000000 -hiaddress 0x007FFFFF 


ihwconnect       -instancename cpu3_tlb    -bus cpu3_iobus -busslaveport TLB_CSR -loaddress 0x00300000 -hiaddress 0x003003FF
...
isetattribute    -handle       cpu3_timer_10ms -name timeoutPeriod   -value 50000 
...
# 0x00400000 - 0x00400017 timestamp
ihwaddperipheral -instancename cpu3_timestamp -vendor mcgill.ca -type IntervalTimer64Core -diagnosticlevel 0
ihwconnect       -instancename cpu3_timestamp -bus cpu3_iobus -busslaveport sp1 -loaddress 0x00000000 -hiaddress 0x00000027
isetattribute    -handle       cpu3_timestamp -name timerFrequency  -value 50000000
isetattribute    -handle       cpu3_timestamp -name timeoutPeriod   -value 50000
...
# FPRINT
#
ihwaddperipheral -instancename cpu3_fprint -vendor mcgill.ca -type fprint -version 3.0 -diagnosticlevel 0
ihwconnect       -instancename cpu3_fprint    -bus cpu3_iobus -busslaveport FPRINT_CSR_SLAVE -loaddress 0x0100000 -hiaddress 0x010013F
isetattribute    -handle       cpu3_fprint -name coreID  -value 0


ihwconnect       -instancename cpu3_fprint    -netport FPRINT_WRITE              -net fprint_write_0
ihwconnect       -instancename cpu3           -netport fprint_write_out          -net fprint_write_0

ihwconnect       -instancename cpu3_fprint    -netport FPRINT_WRITE_ADDRESS      -net fprint_write_address_0
ihwconnect       -instancename cpu3           -netport fprint_write_out_address  -net fprint_write_address_0

ihwconnect       -instancename cpu3_fprint    -netport FPRINT_WRITE_DATA         -net fprint_write_data_0
ihwconnect       -instancename cpu3           -netport fprint_write_out_data     -net fprint_write_data_0

ihwaddbus 		 -instancename cpu3_tlb_fprint_bus   -addresswidth 32
ihwconnect       -instancename cpu3_tlb    -bus cpu3_tlb_fprint_bus    -busmasterport TLB_FPRINT_MASTER -loaddress 0x0000000 -hiaddress 0x07FFFFFF
ihwconnect       -instancename cpu3_fprint -bus cpu3_tlb_fprint_bus    -busslaveport  FPRINT_TLB_SLAVE  -loaddress 0x000000  -hiaddress 0x000003FF


# SW_RESET
ihwconnect       -instancename sw_reset        -netport cpu3_reset   -net cpu3_reset1
# ihwconnect       -instancename cpu3            -netport reset_n      -net cpu3_reset1
ihwconnect 		 -instancename cpu3_fprint 	   -netport FPRINT_RESET -net cpu3_reset1;
# ihwconnect 		 -instancename cpu3_tlb 	   -netport TLB_RESET    -net cpu3_reset1;
...
ihwconnect 	 -instancename cpum_mm_out_bridge_i -busslaveport  sp1 -bus cpum_ibus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpum_mm_out_bridge_i -busmasterport mp1 -bus mmbus      -loaddress 0x00000000 -hiaddress 0x000F9FFF

ihwaddbridge -instancename cpum_mm_out_bridge_d
ihwconnect 	 -instancename cpum_mm_out_bridge_d -busslaveport  sp1 -bus cpum_dbus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpum_mm_out_bridge_d -busmasterport mp1 -bus mmbus      -loaddress 0x00000000 -hiaddress 0x000F9FFF
...
isetattribute    -handle       cpum_timer_10ms -name timeoutPeriod   -value 50000 
...
ihwconnect       -instancename cpu2_dma -bus cpum_dbus   -busslaveport  DMACSP -loaddress 0x2120000 -hiaddress 0x212001F

ihwaddbridge -instancename cpu2_dmasp_bridge
ihwconnect 	 -instancename cpu2_dmasp_bridge -busslaveport  sp1 -bus cpu2_dmabus   -loaddress 0x04000000 -hiaddress 0x087FFFFF
ihwconnect   -instancename cpu2_dmasp_bridge -busmasterport mp1 -bus cpu2_tlbbus   -loaddress 0x04000000 -hiaddress 0x087FFFFF
...
ihwconnect       -instancename cpu3_dma -bus cpum_dbus   -busslaveport  DMACSP -loaddress 0x2130000 -hiaddress 0x213001F

ihwaddbridge -instancename cpu3_dmasp_bridge
ihwconnect 	 -instancename cpu3_dmasp_bridge -busslaveport  sp1 -bus cpu3_dmabus   -loaddress 0x04000000 -hiaddress 0x087FFFFF
ihwconnect   -instancename cpu3_dmasp_bridge -busmasterport mp1 -bus cpu3_tlbbus   -loaddress 0x04000000 -hiaddress 0x087FFFFF
...
ihwaddbridge -instancename comp_bridge_2
ihwconnect 	 -instancename comp_bridge_2 -busslaveport   sp1 -bus cpu2_tlbbus        -loaddress 0x01000000 -hiaddress 0x01000FFF
ihwconnect 	 -instancename comp_bridge_2 -busmasterport  mp1 -bus compbus            -loaddress 0x01000000 -hiaddress 0x01000FFF


ihwaddbridge -instancename comp_bridge_3
ihwconnect 	 -instancename comp_bridge_3 -busslaveport   sp1 -bus cpu3_tlbbus        -loaddress 0x01000000 -hiaddress 0x01000FFF
ihwconnect 	 -instancename comp_bridge_3 -busmasterport  mp1 -bus compbus            -loaddress 0x01000000 -hiaddress 0x01000FFF
...
ihwaddbridge -instancename cpu2_reset_mon_bridge
ihwconnect 	 -instancename cpu2_reset_mon_bridge -busslaveport  sp1 -bus cpu2_tlbbus  -loaddress 0x02800000 -hiaddress 0x028003FF
ihwconnect   -instancename cpu2_reset_mon_bridge -busmasterport mp1 -bus resetmonbus  -loaddress 0x00000000 -hiaddress 0x000003FF

ihwaddbridge -instancename cpu3_reset_mon_bridge
ihwconnect 	 -instancename cpu3_reset_mon_bridge -busslaveport  sp1 -bus cpu3_tlbbus  -loaddress 0x02800000 -hiaddress 0x028003FF
ihwconnect   -instancename cpu3_reset_mon_bridge -busmasterport mp1 -bus resetmonbus  -loaddress 0x00000000 -hiaddress 0x000003FF
