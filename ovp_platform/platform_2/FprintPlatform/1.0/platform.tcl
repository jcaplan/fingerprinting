...
define CPU0_CPU_IMPLEMENTATION "fast"
...
define CPU0_EXCEPTION_ADDR 0x00400020
...
define CPU0_HAS_EXTRA_EXCEPTION_INFO
define CPU0_HAS_ILLEGAL_INSTRUCTION_EXCEPTION
define CPU0_HAS_ILLEGAL_MEMORY_ACCESS_EXCEPTION
...
define CPU0_MPU_MIN_DATA_REGION_SIZE 1024
define CPU0_MPU_MIN_DATA_REGION_SIZE_LOG2 10
define CPU0_MPU_MIN_INST_REGION_SIZE 4096
define CPU0_MPU_MIN_INST_REGION_SIZE_LOG2 12
define CPU0_MPU_NUM_DATA_REGIONS 16
define CPU0_MPU_NUM_INST_REGIONS 8
define CPU0_MPU_PRESENT
define CPU0_NUM_OF_SHADOW_REG_SETS 0
define CPU0_RESET_ADDR 0x00400000
###
###
###
ihwaddprocessor \
...
ihwconnect 	 -instancename cpu0_mm_out_bridge_i -busslaveport  sp1 -bus cpu0_ibus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpu0_mm_out_bridge_i -busmasterport mp1 -bus mmbus      -loaddress 0x00000000 -hiaddress 0x000F9FFF

ihwaddbridge -instancename cpu0_mm_out_bridge_d
ihwconnect 	 -instancename cpu0_mm_out_bridge_d -busslaveport  sp1 -bus cpu0_dbus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpu0_mm_out_bridge_d -busmasterport mp1 -bus mmbus      -loaddress 0x00000000 -hiaddress 0x000F9FFF
...
# FPRINT
#
ihwaddperipheral -instancename cpu0_fprint -version 1.0 -vendor mcgill.ca -type fprint -diagnosticlevel 0
...
ihwconnect 	 -instancename cpu1_mm_out_bridge_i -busslaveport  sp1 -bus cpu1_ibus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpu1_mm_out_bridge_i -busmasterport mp1 -bus mmbus      -loaddress 0x00000000 -hiaddress 0x000F9FFF

ihwaddbridge -instancename cpu1_mm_out_bridge_d
ihwconnect 	 -instancename cpu1_mm_out_bridge_d -busslaveport  sp1 -bus cpu1_dbus  -loaddress 0x00400000 -hiaddress 0x004F9FFF
ihwconnect   -instancename cpu1_mm_out_bridge_d -busmasterport mp1 -bus mmbus      -loaddress 0x00000000 -hiaddress 0x000F9FFF
...
# FPRINT
#
ihwaddperipheral -instancename cpu1_fprint -version 1.0 -vendor mcgill.ca -type fprint -diagnosticlevel 0
...
define CPUM_EXCEPTION_ADDR 0x00464020
...
define CPUM_RESET_ADDR 0x00464000
...
#Relative to platform directory
define elf0 ../../fprint_fpga/quartus/full_system_arria_2/software/ucos0/ucos0.elf
ihwaddimagefile -handle cpu0 -filename ${elf0} -loadphysical false -useobjectentry true -name "fprint0"

define elf1 ../../fprint_fpga/quartus/full_system_arria_2/software/ucos1/ucos1.elf
ihwaddimagefile -handle cpu1 -filename ${elf1} -loadphysical false -useobjectentry true -name "fprint1"

define elfm ../../fprint_fpga/quartus/full_system_arria_2/software/ucosMon/ucosMon.elf
