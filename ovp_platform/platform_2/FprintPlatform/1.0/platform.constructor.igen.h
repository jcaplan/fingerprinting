...
////////////////////////////////////////////////////////////////////////////////
    ...
    icmAddUns64Attr(cpu0_attrList, "EXCEPTION_VECTOR", 0x00400020LL);
    icmAddUns64Attr(cpu0_attrList, "RESET_VECTOR", 0x00400000LL);
    icmAddUns64Attr(cpu0_attrList, "HW_DIVIDE", 0LL);
    icmAddUns64Attr(cpu0_attrList, "HW_MULTIPLY", 0LL);
    icmAddUns64Attr(cpu0_attrList, "HW_MULX", 0LL);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    icmAddUns64Attr(cpu1_attrList, "HW_DIVIDE", 0LL);
    icmAddUns64Attr(cpu1_attrList, "HW_MULTIPLY", 0LL);
    icmAddUns64Attr(cpu1_attrList, "HW_MULX", 0LL);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    icmAddUns64Attr(cpum_attrList, "EXCEPTION_VECTOR", 0x00464020LL);
    icmAddUns64Attr(cpum_attrList, "RESET_VECTOR", 0x00464000LL);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    icmNewBusBridge(handles.cpu0_ibus_b, handles.mmbus_b, "cpu0_mm_out_bridge_i", "sp1", "mp1", 0x0, 0xf9fff, 0x400000);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    icmNewBusBridge(handles.cpu0_dbus_b, handles.mmbus_b, "cpu0_mm_out_bridge_d", "sp1", "mp1", 0x0, 0xf9fff, 0x400000);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    icmNewBusBridge(handles.cpu1_ibus_b, handles.mmbus_b, "cpu1_mm_out_bridge_i", "sp1", "mp1", 0x0, 0xf9fff, 0x400000);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    icmNewBusBridge(handles.cpu1_dbus_b, handles.mmbus_b, "cpu1_mm_out_bridge_d", "sp1", "mp1", 0x0, 0xf9fff, 0x400000);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if(!icmLoadProcessorMemory(handles.cpu0_c, "../../fprint_fpga/quartus/full_system_arria_2/software/ucos0/ucos0.elf", 0, 0, 1)){
        icmPrintf("%s", icmLastMessage());
        icmTerminate();
        icmExitSimulation(1);
    }

    if(!icmLoadProcessorMemory(handles.cpu1_c, "../../fprint_fpga/quartus/full_system_arria_2/software/ucos1/ucos1.elf", 0, 0, 1)){
        icmPrintf("%s", icmLastMessage());
        icmTerminate();
        icmExitSimulation(1);
    }

    if(!icmLoadProcessorMemory(handles.cpum_c, "../../fprint_fpga/quartus/full_system_arria_2/software/ucosMon/ucosMon.elf", 0, 0, 1)){
        icmPrintf("%s", icmLastMessage());
        icmTerminate();
        icmExitSimulation(1);
    }
