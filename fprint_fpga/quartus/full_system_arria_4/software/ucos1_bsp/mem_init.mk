...
MEM_1 := nios_fprint_processor1_0_scratchpad
$(MEM_1)_NAME := processor1_0_scratchpad
...
$(MEM_1)_HIERARCHICAL_PATH := processor1_0.scratchpad
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: processor1_0_scratchpad
processor1_0_scratchpad: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
...
$(MEM_2)_START := 0x03000000
$(MEM_2)_END := 0x030003ff
