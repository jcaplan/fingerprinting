...
int *isr_4_oflow_ptr = (int *) PROCESSOR4_0_CPU_CHECKPOINT_IRQ_0_BASE;
...
static void init_cpu4_oflow_isr(void) {
	alt_ic_isr_register(PROCESSOR4_0_CPU_CHECKPOINT_IRQ_0_IRQ_INTERRUPT_CONTROLLER_ID,
			PROCESSOR4_0_CPU_CHECKPOINT_IRQ_0_IRQ, handle_cpu4_oflow_interrupt, (void*) NULL,
			(void*) NULL);
}
