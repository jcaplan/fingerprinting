...
# setting hal.stderr is processorM_0_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev processorM_0_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is processorM_0_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev processorM_0_jtag_uart
...
# setting hal.stdout is processorM_0_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev processorM_0_jtag_uart
