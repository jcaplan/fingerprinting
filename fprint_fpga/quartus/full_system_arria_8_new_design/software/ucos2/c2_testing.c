...
int *isr_2_oflow_ptr = (int *) PROCESSOR2_0_CPU_CHECKPOINT_IRQ_0_BASE;
...
static void init_cpu2_oflow_isr(void) {
	alt_ic_isr_register(PROCESSOR2_0_CPU_CHECKPOINT_IRQ_0_IRQ_INTERRUPT_CONTROLLER_ID,
			PROCESSOR2_0_CPU_CHECKPOINT_IRQ_0_IRQ, handle_cpu2_oflow_interrupt, (void*) NULL,
			(void*) NULL);
}
