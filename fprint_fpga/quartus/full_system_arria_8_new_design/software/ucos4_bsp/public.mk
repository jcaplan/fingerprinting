...
# CPU Name 
# setting CPU_NAME is processor4_0_cpu4
CPU_NAME = processor4_0_cpu4
...
# setting hal.stderr is processor4_0_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev processor4_0_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is processor4_0_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev processor4_0_jtag_uart
...
# setting hal.stdout is processor4_0_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev processor4_0_jtag_uart
