...
void start_task(INT8U task_id, INT8U nmr, INT8U C0, INT8U C1, INT8U C2, INT8U length, INT8U fprint_enable) {


	comp_set_nmr(task_id,nmr);
...
///*
			...
			C1 = 1;
			C2 = 2;
			start_task(task_id, nmr, C0, C1, C2, length, fprint_en);
//*/
...
int main(void) {
	...
	for(i = 0; i < CA_TABLE_NUM_TASKS; i++){
		comp_set_success_maxcount_value(i,maxcount);
	}
