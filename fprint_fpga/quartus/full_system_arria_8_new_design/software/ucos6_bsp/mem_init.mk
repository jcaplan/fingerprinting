...
# Memory: processor6_0_scratchpad
MEM_1 := nios_fprint_processor6_0_scratchpad
$(MEM_1)_NAME := processor6_0_scratchpad
...
$(MEM_1)_HIERARCHICAL_PATH := processor6_0.scratchpad
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: processor6_0_scratchpad
processor6_0_scratchpad: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
