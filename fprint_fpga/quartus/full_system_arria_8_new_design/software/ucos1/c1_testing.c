...
int *isr_1_oflow_ptr = (int *) PROCESSOR1_0_CPU_CHECKPOINT_IRQ_0_BASE;
...
static void init_cpu1_oflow_isr(void) {
	alt_ic_isr_register(PROCESSOR1_0_CPU_CHECKPOINT_IRQ_0_IRQ_INTERRUPT_CONTROLLER_ID,
			PROCESSOR1_0_CPU_CHECKPOINT_IRQ_0_IRQ, handle_cpu1_oflow_interrupt, (void*) NULL,
			(void*) NULL);
}
