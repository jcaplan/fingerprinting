...
int *isr_0_oflow_ptr = (int *) PROCESSOR0_0_CPU_CHECKPOINT_IRQ_0_BASE;
...
static void init_cpu0_oflow_isr(void) {
	alt_ic_isr_register(PROCESSOR0_0_CPU_CHECKPOINT_IRQ_0_IRQ_INTERRUPT_CONTROLLER_ID,
			PROCESSOR0_0_CPU_CHECKPOINT_IRQ_0_IRQ, handle_cpu0_oflow_interrupt, (void*) NULL,
			(void*) NULL);
}
