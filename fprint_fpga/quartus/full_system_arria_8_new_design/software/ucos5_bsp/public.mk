...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios_fprint.sopcinfo
...
# CPU Name 
# setting CPU_NAME is processor5_0_cpu5
CPU_NAME = processor5_0_cpu5
...
# Design Name 
# setting SOPC_NAME is nios_fprint
SOPC_NAME := nios_fprint
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x801000
SOPC_SYSID_FLAG += --sidp=0x801000
ELF_PATCH_FLAG  += --sidp 0x801000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1441998693
SOPC_SYSID_FLAG += --timestamp=1441998693
ELF_PATCH_FLAG  += --timestamp 1441998693
...
# setting hal.stderr is processor5_0_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev processor5_0_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is processor5_0_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev processor5_0_jtag_uart
...
# setting hal.stdout is processor5_0_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev processor5_0_jtag_uart
