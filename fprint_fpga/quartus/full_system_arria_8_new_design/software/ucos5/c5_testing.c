...
int *isr_5_oflow_ptr = (int *) PROCESSOR5_0_CPU_CHECKPOINT_IRQ_0_BASE;
...
static void init_cpu5_oflow_isr(void) {
	alt_ic_isr_register(PROCESSOR5_0_CPU_CHECKPOINT_IRQ_0_IRQ_INTERRUPT_CONTROLLER_ID,
			PROCESSOR5_0_CPU_CHECKPOINT_IRQ_0_IRQ, handle_cpu5_oflow_interrupt, (void*) NULL,
			(void*) NULL);
}
