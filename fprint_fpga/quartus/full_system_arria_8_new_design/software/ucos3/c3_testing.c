...
int *isr_3_oflow_ptr = (int *) PROCESSOR3_0_CPU_CHECKPOINT_IRQ_0_BASE;
...
static void init_cpu3_oflow_isr(void) {
	alt_ic_isr_register(PROCESSOR3_0_CPU_CHECKPOINT_IRQ_0_IRQ_INTERRUPT_CONTROLLER_ID,
			PROCESSOR3_0_CPU_CHECKPOINT_IRQ_0_IRQ, handle_cpu3_oflow_interrupt, (void*) NULL,
			(void*) NULL);
}
