...
int *isr_7_oflow_ptr = (int *) PROCESSOR7_0_CPU_CHECKPOINT_IRQ_0_BASE;

alt_u64 t_oflow = 0;

CriticalFunctionPointers* cp = (CriticalFunctionPointers*)SHARED_MEMORY_BASE;

#define	  PHYSICAL_CORE_ID	   7
...
static void init_cpu7_oflow_isr(void) {
	alt_ic_isr_register(PROCESSOR7_0_CPU_CHECKPOINT_IRQ_0_IRQ_INTERRUPT_CONTROLLER_ID,
			PROCESSOR7_0_CPU_CHECKPOINT_IRQ_0_IRQ, handle_cpu7_oflow_interrupt, (void*) NULL,
			(void*) NULL);
}
