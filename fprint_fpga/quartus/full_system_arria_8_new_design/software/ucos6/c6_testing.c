...
int *isr_6_oflow_ptr = (int *) PROCESSOR6_0_CPU_CHECKPOINT_IRQ_0_BASE;

alt_u64 t_oflow = 0;

CriticalFunctionPointers* cp = (CriticalFunctionPointers*)SHARED_MEMORY_BASE;

#define	  PHYSICAL_CORE_ID	   6
...
static void init_cpu6_oflow_isr(void) {
	alt_ic_isr_register(PROCESSOR6_0_CPU_CHECKPOINT_IRQ_0_IRQ_INTERRUPT_CONTROLLER_ID,
			PROCESSOR6_0_CPU_CHECKPOINT_IRQ_0_IRQ, handle_cpu6_oflow_interrupt, (void*) NULL,
			(void*) NULL);
}
