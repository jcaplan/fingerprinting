...
proc compose { } {
    ...
    set_instance_parameter_value cpu0 {resetOffset} {4194304}
    set_instance_parameter_value cpu0 {exceptionOffset} {4194336}
    ...
    add_connection cpu0.instruction_master timer.s1 avalon
    set_connection_parameter_value cpu0.instruction_master/timer.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu0.instruction_master/timer.s1 baseAddress {0x08001020}
    set_connection_parameter_value cpu0.instruction_master/timer.s1 defaultConnection {0}
    ...
    add_connection cpu0.data_master button_pio.s1 avalon
    set_connection_parameter_value cpu0.data_master/button_pio.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu0.data_master/button_pio.s1 baseAddress {0x08002000}
    set_connection_parameter_value cpu0.data_master/button_pio.s1 defaultConnection {0}
    ...
    add_connection cpu0.data_master scratchpad.s1 avalon
    set_connection_parameter_value cpu0.data_master/scratchpad.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu0.data_master/scratchpad.s1 baseAddress {0x08200000}
    set_connection_parameter_value cpu0.data_master/scratchpad.s1 defaultConnection {0}
    ...
    add_connection cpu0.data_master out_system_bridge.s0 avalon
    set_connection_parameter_value cpu0.data_master/out_system_bridge.s0 arbitrationPriority {1}
    set_connection_parameter_value cpu0.data_master/out_system_bridge.s0 baseAddress {0x0000}
    set_connection_parameter_value cpu0.data_master/out_system_bridge.s0 defaultConnection {0}
    ...
    add_connection cpu0.instruction_master out_system_bridge.s0 avalon
    set_connection_parameter_value cpu0.instruction_master/out_system_bridge.s0 arbitrationPriority {1}
    set_connection_parameter_value cpu0.instruction_master/out_system_bridge.s0 baseAddress {0x0000}
    set_connection_parameter_value cpu0.instruction_master/out_system_bridge.s0 defaultConnection {0}
