...
`define COMPARATOR_EXCEPTION_OFFSET 			'h00
`define COMPARATOR_STATUS_REG_OFFSET 			'h01 // reserved
`define COMPARATOR_SUCCESS_REG_OFFSET           'h02
`define COMPARATOR_FAIL_REG_OFFSET              'h03
`define COMPARATOR_CORE_ASSIGNMENT_OFFSET		'h04
`define COMPARATOR_NMR_OFFSET					'h05
`define COMPARATOR_MAXCOUNT_REG_OFFSET			'h06
...
`define CHECKPOINT_OFFSET						27'h6000000
