...
proc compose { } {
    ...
    set_instance_parameter_value cpu3 {muldiv_divider} {0}
    set_instance_parameter_value cpu3 {mpu_useLimit} {0}
    ...
    set_instance_parameter_value cpu3 {resetOffset} {4587520}
    set_instance_parameter_value cpu3 {exceptionOffset} {4587552}
    set_instance_parameter_value cpu3 {cpuID} {4}
    set_instance_parameter_value cpu3 {cpuID_stored} {4}
    ...
    set_instance_parameter_value cpu3 {muldiv_multiplierType} {NoneSmall}
    set_instance_parameter_value cpu3 {mpu_minInstRegionSize} {12}
    set_instance_parameter_value cpu3 {mpu_minDataRegionSize} {10}
    ...
    set_instance_parameter_value Fingerprint_0 {CORE_ID} {3}
    ...
    add_connection cpu3.instruction_master timer.s1 avalon
    set_connection_parameter_value cpu3.instruction_master/timer.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu3.instruction_master/timer.s1 baseAddress {0x08001020}
    set_connection_parameter_value cpu3.instruction_master/timer.s1 defaultConnection {0}
    ...
    add_connection cpu3.data_master button_pio.s1 avalon
    set_connection_parameter_value cpu3.data_master/button_pio.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu3.data_master/button_pio.s1 baseAddress {0x08002000}
    set_connection_parameter_value cpu3.data_master/button_pio.s1 defaultConnection {0}
    ...
    add_connection cpu3.data_master scratchpad.s1 avalon
    set_connection_parameter_value cpu3.data_master/scratchpad.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu3.data_master/scratchpad.s1 baseAddress {0x08200000}
    set_connection_parameter_value cpu3.data_master/scratchpad.s1 defaultConnection {0}
    ...
    add_connection cpu3.data_master out_system_bridge.s0 avalon
    set_connection_parameter_value cpu3.data_master/out_system_bridge.s0 arbitrationPriority {1}
    set_connection_parameter_value cpu3.data_master/out_system_bridge.s0 baseAddress {0x0000}
    set_connection_parameter_value cpu3.data_master/out_system_bridge.s0 defaultConnection {0}
    ...
    add_connection cpu3.instruction_master out_system_bridge.s0 avalon
    set_connection_parameter_value cpu3.instruction_master/out_system_bridge.s0 arbitrationPriority {1}
    set_connection_parameter_value cpu3.instruction_master/out_system_bridge.s0 baseAddress {0x0000}
    set_connection_parameter_value cpu3.instruction_master/out_system_bridge.s0 defaultConnection {0}
