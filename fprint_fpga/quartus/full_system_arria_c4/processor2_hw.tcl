...
# module properties
set_module_property NAME {processor2_export}
set_module_property DISPLAY_NAME {processor2_export_display}
...
proc compose { } {
    ...
    add_instance cpu2 altera_nios2_qsys 13.1
    set_instance_parameter_value cpu2 {setting_showUnpublishedSettings} {0}
    set_instance_parameter_value cpu2 {setting_showInternalSettings} {0}
    set_instance_parameter_value cpu2 {setting_preciseSlaveAccessErrorException} {0}
    set_instance_parameter_value cpu2 {setting_preciseIllegalMemAccessException} {0}
    set_instance_parameter_value cpu2 {setting_preciseDivisionErrorException} {0}
    set_instance_parameter_value cpu2 {setting_performanceCounter} {0}
    set_instance_parameter_value cpu2 {setting_illegalMemAccessDetection} {0}
    set_instance_parameter_value cpu2 {setting_illegalInstructionsTrap} {0}
    set_instance_parameter_value cpu2 {setting_fullWaveformSignals} {0}
    set_instance_parameter_value cpu2 {setting_extraExceptionInfo} {0}
    set_instance_parameter_value cpu2 {setting_exportPCB} {0}
    set_instance_parameter_value cpu2 {setting_debugSimGen} {0}
    set_instance_parameter_value cpu2 {setting_clearXBitsLDNonBypass} {1}
    set_instance_parameter_value cpu2 {setting_bit31BypassDCache} {1}
    set_instance_parameter_value cpu2 {setting_bigEndian} {0}
    set_instance_parameter_value cpu2 {setting_export_large_RAMs} {0}
    set_instance_parameter_value cpu2 {setting_asic_enabled} {0}
    set_instance_parameter_value cpu2 {setting_asic_synopsys_translate_on_off} {0}
    set_instance_parameter_value cpu2 {setting_oci_export_jtag_signals} {0}
    set_instance_parameter_value cpu2 {setting_bhtIndexPcOnly} {0}
    set_instance_parameter_value cpu2 {setting_avalonDebugPortPresent} {0}
    set_instance_parameter_value cpu2 {setting_alwaysEncrypt} {1}
    set_instance_parameter_value cpu2 {setting_allowFullAddressRange} {0}
    set_instance_parameter_value cpu2 {setting_activateTrace} {1}
    set_instance_parameter_value cpu2 {setting_activateTrace_user} {0}
    set_instance_parameter_value cpu2 {setting_activateTestEndChecker} {0}
    set_instance_parameter_value cpu2 {setting_ecc_sim_test_ports} {0}
    set_instance_parameter_value cpu2 {setting_activateMonitors} {1}
    set_instance_parameter_value cpu2 {setting_activateModelChecker} {0}
    set_instance_parameter_value cpu2 {setting_HDLSimCachesCleared} {1}
    set_instance_parameter_value cpu2 {setting_HBreakTest} {0}
    set_instance_parameter_value cpu2 {setting_breakslaveoveride} {0}
    set_instance_parameter_value cpu2 {muldiv_divider} {1}
    set_instance_parameter_value cpu2 {mpu_useLimit} {1}
    set_instance_parameter_value cpu2 {mpu_enabled} {1}
    set_instance_parameter_value cpu2 {mmu_enabled} {0}
    set_instance_parameter_value cpu2 {mmu_autoAssignTlbPtrSz} {1}
    set_instance_parameter_value cpu2 {manuallyAssignCpuID} {1}
    set_instance_parameter_value cpu2 {debug_triggerArming} {1}
    set_instance_parameter_value cpu2 {debug_embeddedPLL} {1}
    set_instance_parameter_value cpu2 {debug_debugReqSignals} {0}
    set_instance_parameter_value cpu2 {debug_assignJtagInstanceID} {0}
    set_instance_parameter_value cpu2 {dcache_omitDataMaster} {0}
    set_instance_parameter_value cpu2 {cpuReset} {0}
    set_instance_parameter_value cpu2 {is_hardcopy_compatible} {0}
    set_instance_parameter_value cpu2 {setting_shadowRegisterSets} {0}
    set_instance_parameter_value cpu2 {mpu_numOfInstRegion} {8}
    set_instance_parameter_value cpu2 {mpu_numOfDataRegion} {16}
    set_instance_parameter_value cpu2 {mmu_TLBMissExcOffset} {0}
    ...
    set_instance_parameter_value cpu2 {mmu_TLBMissExcSlave} {}
    set_instance_parameter_value cpu2 {exceptionSlave} {Absolute}
    set_instance_parameter_value cpu2 {breakSlave} {cpu2.jtag_debug_module}
    set_instance_parameter_value cpu2 {setting_perfCounterWidth} {32}
    set_instance_parameter_value cpu2 {setting_interruptControllerType} {Internal}
    set_instance_parameter_value cpu2 {setting_branchPredictionType} {Automatic}
    set_instance_parameter_value cpu2 {setting_bhtPtrSz} {8}
    set_instance_parameter_value cpu2 {muldiv_multiplierType} {DSPBlock}
    set_instance_parameter_value cpu2 {mpu_minInstRegionSize} {6}
    set_instance_parameter_value cpu2 {mpu_minDataRegionSize} {6}
    set_instance_parameter_value cpu2 {mmu_uitlbNumEntries} {4}
    set_instance_parameter_value cpu2 {mmu_udtlbNumEntries} {6}
    set_instance_parameter_value cpu2 {mmu_tlbPtrSz} {7}
    set_instance_parameter_value cpu2 {mmu_tlbNumWays} {16}
    set_instance_parameter_value cpu2 {mmu_processIDNumBits} {8}
    set_instance_parameter_value cpu2 {impl} {Fast}
    set_instance_parameter_value cpu2 {icache_size} {1024}
    set_instance_parameter_value cpu2 {icache_tagramBlockType} {Automatic}
    set_instance_parameter_value cpu2 {icache_ramBlockType} {Automatic}
    set_instance_parameter_value cpu2 {icache_numTCIM} {0}
    set_instance_parameter_value cpu2 {icache_burstType} {None}
    set_instance_parameter_value cpu2 {dcache_bursts} {false}
    set_instance_parameter_value cpu2 {dcache_victim_buf_impl} {ram}
    set_instance_parameter_value cpu2 {debug_level} {Level1}
    set_instance_parameter_value cpu2 {debug_OCIOnchipTrace} {_128}
    set_instance_parameter_value cpu2 {dcache_size} {0}
    set_instance_parameter_value cpu2 {dcache_tagramBlockType} {Automatic}
    set_instance_parameter_value cpu2 {dcache_ramBlockType} {Automatic}
    set_instance_parameter_value cpu2 {dcache_numTCDM} {0}
    set_instance_parameter_value cpu2 {dcache_lineSize} {32}
    set_instance_parameter_value cpu2 {setting_exportvectors} {0}
    set_instance_parameter_value cpu2 {setting_ecc_present} {0}
    set_instance_parameter_value cpu2 {setting_ic_ecc_present} {1}
    set_instance_parameter_value cpu2 {setting_rf_ecc_present} {1}
    set_instance_parameter_value cpu2 {setting_mmu_ecc_present} {1}
    set_instance_parameter_value cpu2 {setting_dc_ecc_present} {0}
    set_instance_parameter_value cpu2 {setting_itcm_ecc_present} {0}
    set_instance_parameter_value cpu2 {setting_dtcm_ecc_present} {0}
    set_instance_parameter_value cpu2 {regfile_ramBlockType} {Automatic}
    set_instance_parameter_value cpu2 {ocimem_ramBlockType} {Automatic}
    set_instance_parameter_value cpu2 {mmu_ramBlockType} {Automatic}
    set_instance_parameter_value cpu2 {bht_ramBlockType} {Automatic}
    ...
    add_connection clk.clk cpu2.clk clock

    add_connection clk.clk_reset cpu2.reset_n reset

    add_connection clk.clk_reset timer.reset reset

    add_connection cpu2.d_irq timer.irq interrupt
    set_connection_parameter_value cpu2.d_irq/timer.irq irqNumber {0}
    ...
    add_connection cpu2.d_irq jtag_uart.irq interrupt
    set_connection_parameter_value cpu2.d_irq/jtag_uart.irq irqNumber {4}

    add_connection clk.clk button_pio.clk clock

    add_connection clk.clk_reset button_pio.reset reset

    add_connection cpu2.d_irq button_pio.irq interrupt
    set_connection_parameter_value cpu2.d_irq/button_pio.irq irqNumber {2}

    add_connection clk.clk cpu_irq_0.clock clock

    add_connection clk.clk_reset cpu_irq_0.reset reset

    add_connection cpu2.d_irq cpu_irq_0.irq0 interrupt
    set_connection_parameter_value cpu2.d_irq/cpu_irq_0.irq0 irqNumber {1}
    ...
    add_connection cpu2.data_master cpu2.jtag_debug_module avalon
    set_connection_parameter_value cpu2.data_master/cpu2.jtag_debug_module arbitrationPriority {1}
    set_connection_parameter_value cpu2.data_master/cpu2.jtag_debug_module baseAddress {0x08000800}
    set_connection_parameter_value cpu2.data_master/cpu2.jtag_debug_module defaultConnection {0}

    add_connection cpu2.instruction_master cpu2.jtag_debug_module avalon
    set_connection_parameter_value cpu2.instruction_master/cpu2.jtag_debug_module arbitrationPriority {1}
    set_connection_parameter_value cpu2.instruction_master/cpu2.jtag_debug_module baseAddress {0x08000800}
    set_connection_parameter_value cpu2.instruction_master/cpu2.jtag_debug_module defaultConnection {0}

    add_connection cpu2.data_master timer.s1 avalon
    set_connection_parameter_value cpu2.data_master/timer.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu2.data_master/timer.s1 baseAddress {0x08001020}
    set_connection_parameter_value cpu2.data_master/timer.s1 defaultConnection {0}

    add_connection cpu2.data_master jtag_uart.avalon_jtag_slave avalon
    set_connection_parameter_value cpu2.data_master/jtag_uart.avalon_jtag_slave arbitrationPriority {1}
    set_connection_parameter_value cpu2.data_master/jtag_uart.avalon_jtag_slave baseAddress {0x08001040}
    set_connection_parameter_value cpu2.data_master/jtag_uart.avalon_jtag_slave defaultConnection {0}

    add_connection cpu2.data_master timestamp.s1 avalon
    set_connection_parameter_value cpu2.data_master/timestamp.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu2.data_master/timestamp.s1 baseAddress {0x08000000}
    set_connection_parameter_value cpu2.data_master/timestamp.s1 defaultConnection {0}

    add_connection cpu2.data_master Fingerprint_0.avalon_slave_0 avalon
    set_connection_parameter_value cpu2.data_master/Fingerprint_0.avalon_slave_0 arbitrationPriority {1}
    set_connection_parameter_value cpu2.data_master/Fingerprint_0.avalon_slave_0 baseAddress {0x08100000}
    set_connection_parameter_value cpu2.data_master/Fingerprint_0.avalon_slave_0 defaultConnection {0}

    add_connection cpu2.data_master utlb_0.avalon_slave avalon
    set_connection_parameter_value cpu2.data_master/utlb_0.avalon_slave arbitrationPriority {1}
    set_connection_parameter_value cpu2.data_master/utlb_0.avalon_slave baseAddress {0x0000}
    set_connection_parameter_value cpu2.data_master/utlb_0.avalon_slave defaultConnection {0}

    add_connection cpu2.instruction_master utlb_0.avalon_slave avalon
    set_connection_parameter_value cpu2.instruction_master/utlb_0.avalon_slave arbitrationPriority {1}
    set_connection_parameter_value cpu2.instruction_master/utlb_0.avalon_slave baseAddress {0x0000}
    set_connection_parameter_value cpu2.instruction_master/utlb_0.avalon_slave defaultConnection {0}

    add_connection cpu2.data_master utlb_0.ctrl_reg avalon
    set_connection_parameter_value cpu2.data_master/utlb_0.ctrl_reg arbitrationPriority {1}
    set_connection_parameter_value cpu2.data_master/utlb_0.ctrl_reg baseAddress {0x08300000}
    set_connection_parameter_value cpu2.data_master/utlb_0.ctrl_reg defaultConnection {0}
    ...
    add_connection cpu2.custom_instruction_master nios_custom_instr_floating_point_2_0.s1 nios_custom_instruction
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s1 CIName {nios_custom_instr_floating_point_2_0}
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s1 CINameUpgrade {}
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s1 arbitrationPriority {1}
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s1 baseAddress {224.0}
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s1 opcodeExtensionUpgrade {-1}

    add_connection cpu2.custom_instruction_master nios_custom_instr_floating_point_2_0.s2 nios_custom_instruction
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s2 CIName {nios_custom_instr_floating_point_2_0_1}
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s2 CINameUpgrade {}
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s2 arbitrationPriority {1}
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s2 baseAddress {248.0}
    set_connection_parameter_value cpu2.custom_instruction_master/nios_custom_instr_floating_point_2_0.s2 opcodeExtensionUpgrade {-1}
    ...
    set_interface_property cpu0_jtag_debug_module_reset EXPORT_OF cpu2.jtag_debug_module_reset
