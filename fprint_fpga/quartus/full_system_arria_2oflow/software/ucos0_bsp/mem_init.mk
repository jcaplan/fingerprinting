...
# Memory: processor0_0_scratchpad
MEM_2 := nios_fprint_processor0_0_scratchpad
$(MEM_2)_NAME := processor0_0_scratchpad
...
$(MEM_2)_HIERARCHICAL_PATH := processor0_0.scratchpad
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: processor0_0_scratchpad
processor0_0_scratchpad: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
