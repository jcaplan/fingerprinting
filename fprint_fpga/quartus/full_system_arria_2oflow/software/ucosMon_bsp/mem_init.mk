...
# Memory: memory_0_generic_tristate_controller_0
MEM_0 := memory_0_generic_tristate_controller_0
$(MEM_0)_NAME := memory_0_generic_tristate_controller_0
...
$(MEM_0)_HIERARCHICAL_PATH := memory_0.generic_tristate_controller_0
$(MEM_0)_WIDTH := 16
...
.PHONY: memory_0_generic_tristate_controller_0
memory_0_generic_tristate_controller_0: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash

# Memory: memory_0_onchip_memoryMain
MEM_1 := nios_fprint_memory_0_onchip_memoryMain
$(MEM_1)_NAME := memory_0_onchip_memoryMain
...
$(MEM_1)_END := 0x004f9fff
$(MEM_1)_HIERARCHICAL_PATH := memory_0.onchip_memoryMain
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: memory_0_onchip_memoryMain
memory_0_onchip_memoryMain: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: processorM_0_scratchpad
MEM_2 := nios_fprint_processorM_0_scratchpad
$(MEM_2)_NAME := processorM_0_scratchpad
...
$(MEM_2)_END := 0x08203fff
$(MEM_2)_HIERARCHICAL_PATH := processorM_0.scratchpad
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: processorM_0_scratchpad
processorM_0_scratchpad: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
...
$(MEM_3)_START := 0x03000000
$(MEM_3)_END := 0x030003ff
