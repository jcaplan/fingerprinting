...
void (*ct)(int);
void (*pt)(void*);
int *isr_4_ptr = (int *) PROCESSOR4_0_CPU_IRQ_0_BASE;	//Pointer to IRQ Register
int *isr_4_oflow_ptr = (int *) PROCESSOR4_0_CPU_OFLOW_IRQ_0_BASE; //Pointer to oflow IRQ Register
int overflow;
								//(CPU0 -> CPU1)
...
int main(void) {
	...
	init_cpu4_isr();										//Initialize the ISR
	init_cpu4_oflow_isr();
