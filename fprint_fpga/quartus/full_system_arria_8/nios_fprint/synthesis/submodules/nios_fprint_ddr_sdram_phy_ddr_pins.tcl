...
# ----------------------------------------------------------------
	...
	set corename "nios_fprint_ddr_sdram_phy"
	array unset pins_t
...
lappend patterns ck_n ${instname}_alt_mem_phy_inst|clk|DDR_CLK_OUT\[*\].ddr_clk_out_n|auto_generated|ddio_outa\[*\]|dataout
	...
	set outputFileName "nios_fprint_ddr_sdram_phy_autodetectedpins.tcl"
...
set nios_fprint_ddr_sdram_phy_use_high_performance_timing 1
if {[namespace which -variable ::override_nios_fprint_ddr_sdram_phy_use_high_performance_timing] != ""} {
	set nios_fprint_ddr_sdram_phy_use_high_performance_timing $::override_nios_fprint_ddr_sdram_phy_use_high_performance_timing
}
