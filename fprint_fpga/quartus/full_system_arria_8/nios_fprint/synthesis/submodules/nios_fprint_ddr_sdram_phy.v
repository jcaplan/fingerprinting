...
// ============================================================
// Megafunction Name(s):
// 			nios_fprint_ddr_sdram_phy_alt_mem_phy
// ============================================================
...
module nios_fprint_ddr_sdram_phy (
	pll_ref_clk,
	global_reset_n,
	soft_reset_n,
	ctl_dqs_burst,
	...
	nios_fprint_ddr_sdram_phy_alt_mem_phy	nios_fprint_ddr_sdram_phy_alt_mem_phy_inst(
	...
	defparam
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.FAMILY = "Cyclone III",
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR",
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 10000,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "10000 ps",
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 50,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 80,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		nios_fprint_ddr_sdram_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="nios_fprint_ddr_sdram_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Custom (PSC A2S56D40CTP-G5)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_trrd_ns" value="11.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "max_local_size" value="1"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="nios_fprint_ddr_sdram_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="nios_fprint_ddr_sdram_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+nios_fprint_ddr_sdram_phy_alt_mem_phy_seq_wrapper;+nios_fprint_ddr_sdram_phy_alt_mem_phy_reconfig;+nios_fprint_ddr_sdram_phy_alt_mem_phy_pll;+nios_fprint_ddr_sdram_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\Jonah\AppData\Local\Temp\alt6133_1935397925026613425.dir\0007_iptb_gen/nios_fprint_ddr_sdram_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="nios_fprint_ddr_sdram_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
