...
module nios_fprint_processor1_0_mm_interconnect_0 (
	...
	wire  [26:0] scratchpad_s1_translator_avalon_universal_slave_0_agent_m0_address;                        // scratchpad_s1_translator_avalon_universal_slave_0_agent:m0_address -> scratchpad_s1_translator:uav_address
	...
	wire  [99:0] scratchpad_s1_translator_avalon_universal_slave_0_agent_rf_source_data;                    // scratchpad_s1_translator_avalon_universal_slave_0_agent:rf_source_data -> scratchpad_s1_translator_avalon_universal_slave_0_agent_rsp_fifo:in_data
	...
	wire  [99:0] scratchpad_s1_translator_avalon_universal_slave_0_agent_rsp_fifo_out_data;                 // scratchpad_s1_translator_avalon_universal_slave_0_agent_rsp_fifo:out_data -> scratchpad_s1_translator_avalon_universal_slave_0_agent:rf_sink_data
	...
	wire         cmd_xbar_mux_src_endofpacket;                                                              // cmd_xbar_mux:src_endofpacket -> scratchpad_s1_translator_avalon_universal_slave_0_agent:cp_endofpacket
	wire         cmd_xbar_mux_src_valid;                                                                    // cmd_xbar_mux:src_valid -> scratchpad_s1_translator_avalon_universal_slave_0_agent:cp_valid
	wire         cmd_xbar_mux_src_startofpacket;                                                            // cmd_xbar_mux:src_startofpacket -> scratchpad_s1_translator_avalon_universal_slave_0_agent:cp_startofpacket
	wire  [98:0] cmd_xbar_mux_src_data;                                                                     // cmd_xbar_mux:src_data -> scratchpad_s1_translator_avalon_universal_slave_0_agent:cp_data
	wire   [2:0] cmd_xbar_mux_src_channel;                                                                  // cmd_xbar_mux:src_channel -> scratchpad_s1_translator_avalon_universal_slave_0_agent:cp_channel
	wire         cmd_xbar_mux_src_ready;                                                                    // scratchpad_s1_translator_avalon_universal_slave_0_agent:cp_ready -> cmd_xbar_mux:src_ready
	...
	wire         scratchpad_s1_translator_avalon_universal_slave_0_agent_rp_endofpacket;                    // scratchpad_s1_translator_avalon_universal_slave_0_agent:rp_endofpacket -> id_router:sink_endofpacket
	wire         scratchpad_s1_translator_avalon_universal_slave_0_agent_rp_valid;                          // scratchpad_s1_translator_avalon_universal_slave_0_agent:rp_valid -> id_router:sink_valid
	wire         scratchpad_s1_translator_avalon_universal_slave_0_agent_rp_startofpacket;                  // scratchpad_s1_translator_avalon_universal_slave_0_agent:rp_startofpacket -> id_router:sink_startofpacket
	wire  [98:0] scratchpad_s1_translator_avalon_universal_slave_0_agent_rp_data;                           // scratchpad_s1_translator_avalon_universal_slave_0_agent:rp_data -> id_router:sink_data
	wire         scratchpad_s1_translator_avalon_universal_slave_0_agent_rp_ready;                          // id_router:sink_ready -> scratchpad_s1_translator_avalon_universal_slave_0_agent:rp_ready
	...
	nios_fprint_processor1_0_mm_interconnect_0_rsp_xbar_demux rsp_xbar_demux_001 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
