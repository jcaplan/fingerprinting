...
proc compose { } {
    ...
    add_connection sw_reset_0.reset_source cpu1.reset_n reset
    ...
    add_interface sw_reset_0_s0 avalon slave
    set_interface_property sw_reset_0_s0 EXPORT_OF sw_reset_0.s0
}
