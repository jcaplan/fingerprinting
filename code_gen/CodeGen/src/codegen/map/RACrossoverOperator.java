...
/**
 * The crossover operator randomly selects two Chromosomes from the population
 * and "mates" them by randomly picking a gene and then swapping that gene and
 * all subsequent genes between the two Chromosomes. The two modified
 * Chromosomes are then added to the list of candidate Chromosomes.
 *
 * If you work with CompositeGenes, this operator expects them to contain genes
 * of the same type (e.g. IntegerGene). If you have mixed types, please provide
 * your own crossover operator.
 *
 * This ModifiedCrossoverOperator supports both fixed and dynamic crossover
...
public class RACrossoverOperator extends CrossoverOperator {
	...
	/**
	 * Constructs a new instance of this ModifiedCrossoverOperator without a
	 * specified crossover rate, this results in dynamic crossover rate being
	 * turned off. This means that the crossover rate will be fixed at
	 * populationsize/2.
	 * <p>
	 ...
	 * @since 2.0
	 */
	public RACrossoverOperator() throws InvalidConfigurationException {
	 ...
	 * @since 3.0
	 */
	public RACrossoverOperator(final Configuration a_configuration)
			throws InvalidConfigurationException {
	...
	/**
	 * Constructs a new instance of this ModifiedCrossoverOperator with a
	 * specified crossover rate calculator, which results in dynamic crossover
	 * being turned on.
	 *
	 * @param a_configuration
	 *            the configuration to use
	...
	/**
	 * Constructs a new instance of this ModifiedCrossoverOperator with the
	 * given crossover rate.
	 *
	 * @param a_configuration
	 *            the configuration to use
	...
	/**
	 * Constructs a new instance of this ModifiedCrossoverOperator with the
	 * given crossover rate. No new chromosomes are x-overed.
	 *
	 * @param a_configuration
	 *            the configuration to use
	 * @param a_desiredCrossoverRate
	...
	public int compareTo(final Object a_other) {
		...
		RACrossoverOperator op = (RACrossoverOperator) a_other;
