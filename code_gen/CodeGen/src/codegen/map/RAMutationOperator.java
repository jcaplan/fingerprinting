 ...
 *
 * This ModifiedMutationOperator supports both fixed and dynamic mutation rates.
...
public class RAMutationOperator
  ...
  /**
   * Constructs a new instance of this ModifiedMutationOperator without a specified
   ...
   * @since 3.0
   */
  public RAMutationOperator(final Configuration a_conf)
      throws InvalidConfigurationException {
    super(a_conf);
  ...
  /**
   * Constructs a new instance of this ModifiedMutationOperator with a specified
   ...
   * @since 1.1
   */
  public RAMutationOperator(final Configuration a_config,
  ...
  /**
   * Constructs a new instance of this ModifiedMutationOperator with the given
   * mutation rate.
   *
   * @param a_config the configuration to use
  ...
  public int compareTo(Object a_other) {
    ...
    RAMutationOperator op = (RAMutationOperator) a_other;
    if (m_mutationRateCalc == null) {
  ...
  class MutationOperatorConfigurable
    ...
    /**
     * The current mutation rate used by this ModifiedMutationOperator, expressed as
