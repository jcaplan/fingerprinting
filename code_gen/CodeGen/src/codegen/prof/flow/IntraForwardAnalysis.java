...
public abstract class IntraForwardAnalysis<A> implements ForwardAnalysisInterface<A>{
	...
	public IntraForwardAnalysis(Function root) {
		func = root;
		setBBList(new ArrayList<>(func.getBasicBlockList()));
		
	}	
	
	public IntraForwardAnalysis(List<BasicBlock> bbList) {
		setBBList(bbList);
	}	
