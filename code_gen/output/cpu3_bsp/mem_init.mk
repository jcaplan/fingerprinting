...
RESET_ADDRESS ?= 0x004c8000

#-------------------------------------
# Pre-Initialized Memory Descriptions
#-------------------------------------

# Memory: memory_0_onchip_memoryMain
MEM_0 := nios_fprint_memory_0_onchip_memoryMain
$(MEM_0)_NAME := memory_0_onchip_memoryMain
...
$(MEM_0)_END := 0x004f9fff
$(MEM_0)_HIERARCHICAL_PATH := memory_0.onchip_memoryMain
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: memory_0_onchip_memoryMain
memory_0_onchip_memoryMain: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: processor3_0_scratchpad_0
MEM_1 := nios_fprint_processor3_0_scratchpad_0
$(MEM_1)_NAME := processor3_0_scratchpad_0
...
$(MEM_1)_START := 0x04200000
$(MEM_1)_END := 0x04203fff
$(MEM_1)_HIERARCHICAL_PATH := processor3_0.scratchpad_0
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: processor3_0_scratchpad_0
processor3_0_scratchpad_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: processor3_0_scratchpad_1
MEM_2 := nios_fprint_processor3_0_scratchpad_1
$(MEM_2)_NAME := processor3_0_scratchpad_1
...
$(MEM_2)_START := 0x04204000
$(MEM_2)_END := 0x04207fff
$(MEM_2)_HIERARCHICAL_PATH := processor3_0.scratchpad_1
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: processor3_0_scratchpad_1
processor3_0_scratchpad_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym

# Memory: shared_memory
MEM_3 := nios_fprint_shared_memory
...
$(MEM_3)_START := 0x02500000
$(MEM_3)_END := 0x025003ff
