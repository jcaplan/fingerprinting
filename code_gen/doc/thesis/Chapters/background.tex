...
\captionsetup[subfigure]{singlelinecheck=false}
\centering
\subcaptionbox{Average HD frequency \label{f:qsort}}[0.45\textwidth]
{
    \includegraphics[width=0.42\textwidth]{qsort.pdf}
}%
\hfill
\subcaptionbox[]{Cumulative HD frequency \label{f:qsort-d}}[0.45\textwidth]
{
    \includegraphics[width=0.42\textwidth]{qsort_d.pdf}
}%
