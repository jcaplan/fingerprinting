...
\addfigure{0.59}{toolarch1.pdf}{Tool architecture}{f:tool-arch}
	...
	2) It then generates the necessary inputs for the profiling tool and collects the results (which can include maximum stack depth and worst case execution time). 
	...
	4) The MS tool returns an optimal schedule and mapping for the task set. 
	5) Finally scripts to configure the BSP are generated as well as a main file for each core that configures all threads and replication related services. 	
