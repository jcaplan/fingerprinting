...
#ifdef WANT_SMALL_STDIO /* ALTERA SMALL STDIO */
...
struct _reent
{
  ...
  /* see comments about WANT_SMALL_STDIO in local.c */
  ...
  struct __sFILE_small_file __sf_fake[3];
#else WANT_SMALL_STDIO
  struct _glue __sglue;			/* root of glue chain */
  __FILE *__sf;			        /* file descriptors */
#endif /* !WANT_SMALL_STDIO */
/* we're missing something here since the 1.12, wondering if it is required */
