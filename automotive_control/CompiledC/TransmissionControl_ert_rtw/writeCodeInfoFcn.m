% Autogenerated file: Mon May  4 13:55:47 2015
function writeCodeInfoFcn


% Load a ComponentInterface object from IR
codeIRInfoStruct = load('/data/jcapla9/fingerprinting/automotive_control/CompiledC/TransmissionControl_ert_rtw/tlc/codeIRInfo.mat');
...
Type_1_R0_V0 = numerictype('single');
  ...
  Type_20_R0_V0.BaseType   = Type_1_R0_V0;
...
% Opaque Data Type
type_RTModel  = embedded.opaquetype('RT_MODEL_TransmissionControl_T');
...
Var_RTModel = RTW.Variable(type_RTModel, 'TransmissionControl_M_');
    Var_RTModel.Owner           = '';
    Var_RTModel.DeclarationFile = '';
    
    
% Pointer Variable: PtrVar_RTModel
PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'TransmissionControl_M', Var_RTModel);
...
idata_RTModel = RTW.DataInterface('', 'Real-time model', PtrVar_RTModel, []);
        ...
        Initialize_RTArg.Name   = 'TransmissionControl_M';
...
Ptrtype_idata_ExternalInput_0_0 = embedded.pointertype;
   Ptrtype_idata_ExternalInput_0_0.BaseType = type_idata_ExternalInput;
    ...
    Ptrtype_idata_ExternalInput_0_0.Volatile = 0;
          ...
          Initialize_EIArg.Name = 'TransmissionControl_U';
...
Ptrtype_idata_ExternalOutput_0_0 = embedded.pointertype;
   Ptrtype_idata_ExternalOutput_0_0.BaseType = type_idata_ExternalOutput;
    ...
    Ptrtype_idata_ExternalOutput_0_0.Volatile = 0;
          ...
          rtYArg.Name = 'TransmissionControl_Y';
...
tmpActualReturn = [];
      ...
      Ptrtype_RTModel_1_0.ReadOnly = 1;
        ...
        OutputUpdate_RTArg.Name   = 'TransmissionControl_M';
  ...
  idata_Parameter = getInternalDataByName(codeInfo.InternalData, 'Parameter');
    if ~isa(idata_Parameter.Implementation,'RTW.PointerExpression') 
        idata_Parameter.Implementation.Identifier = 'TransmissionControl_P';
    end
...
Ptrtype_idata_Parameter_0_0 = embedded.pointertype;
  ...
  type_idata_ExternalInput = idata_ExternalInput.Implementation.Type;
          ...
          OutputUpdate_EIArg.Name = 'TransmissionControl_U';
...
tmpActualReturn = [];
      ...
      Ptrtype_RTModel_1_0.ReadOnly = 1;
        ...
        Terminate_RTArg.Name   = 'TransmissionControl_M';
