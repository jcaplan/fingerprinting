###########################################################################
## Makefile generated for Simulink model 'TransmissionControl'. 
## 
## Makefile     : TransmissionControl.mk
## Generated on : Sun Mar 22 13:54:19 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TransmissionControl
...
PRODUCT_NAME              = TransmissionControl
MAKEFILE                  = TransmissionControl.mk
COMPUTER                  = MACI64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = TransmissionControl_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TransmissionControl
...
INCLUDES_BUILDINFO = -I$(START_DIR)/TransmissionControl_ert_rtw -I$(START_DIR) -I$(START_DIR)/DesignProject -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=TransmissionControl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/TransmissionControl_ert_rtw/TransmissionControl.c $(START_DIR)/TransmissionControl_ert_rtw/TransmissionControl_data.c

MAIN_SRC = $(START_DIR)/TransmissionControl_ert_rtw/ert_main.c
...
OBJS = TransmissionControl.o TransmissionControl_data.o
...
%.o : $(START_DIR)/TransmissionControl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TransmissionControl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
