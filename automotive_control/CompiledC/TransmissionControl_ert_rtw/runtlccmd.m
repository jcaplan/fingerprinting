function runtlccmd
% RUNTLCCMD - run tlc command (regenerate C code from .rtw file) for model TransmissionControl
% This function will run the tlc command stored in the variable 
% "tlccmd" in tlccmd.mat, whose contents is as follows:
% 
% 	tlc
% 	-r
% 	/Users/anthonydelage/Documents/MATLAB/TransmissionControl_ert_rtw/TransmissionControl.rtw
% 	/Applications/MATLAB_R2014a.app/rtw/c/ert/ert.tlc
% 	-O/Users/anthonydelage/Documents/MATLAB/TransmissionControl_ert_rtw
% 	-I/Applications/MATLAB_R2014a.app/rtw/c/ert
% 	-I/Users/anthonydelage/Documents/MATLAB/TransmissionControl_ert_rtw/tlc
...
% 	-p10000
   ...
   if ~sysopen
      ...
      rtwprivate('rtwattic', 'setBuildDir', '/Users/anthonydelage/Documents/MATLAB/TransmissionControl_ert_rtw');
      rtwprivate('ec_set_replacement_flag', 'TransmissionControl');
      load tlccmd.mat;
      savedpwd = pwd;
      cd ..;
