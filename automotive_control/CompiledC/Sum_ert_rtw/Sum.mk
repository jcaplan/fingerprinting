###########################################################################
## Makefile generated for Simulink model 'Sum'. 
## 
## Makefile     : Sum.mk
## Generated on : Sun Mar 22 13:53:04 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Sum
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Sum_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Sum
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Sum_ert_rtw -I$(START_DIR) -I$(START_DIR)/DesignProject -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Sum -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/Sum_ert_rtw/Sum.c

MAIN_SRC = $(START_DIR)/Sum_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/Sum_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Sum_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
