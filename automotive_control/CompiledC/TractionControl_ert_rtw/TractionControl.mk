###########################################################################
## Makefile generated for Simulink model 'TractionControl'. 
## 
## Makefile     : TractionControl.mk
## Generated on : Sun Mar 22 13:37:18 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TractionControl
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = TractionControl_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TractionControl
...
INCLUDES_BUILDINFO = -I$(START_DIR)/TractionControl_ert_rtw -I$(START_DIR) -I$(START_DIR)/DesignProject -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=TractionControl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/TractionControl_ert_rtw/TractionControl.c $(START_DIR)/TractionControl_ert_rtw/TractionControl_data.c

MAIN_SRC = $(START_DIR)/TractionControl_ert_rtw/ert_main.c
...
OBJS = TractionControl.o TractionControl_data.o
...
%.o : $(START_DIR)/TractionControl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TractionControl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
