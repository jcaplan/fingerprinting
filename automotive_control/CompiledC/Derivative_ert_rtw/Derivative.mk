###########################################################################
## Makefile generated for Simulink model 'Derivative'. 
## 
## Makefile     : Derivative.mk
## Generated on : Mon Mar 23 13:34:37 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Derivative
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Derivative_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Derivative
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Derivative_ert_rtw -I$(START_DIR) -I$(START_DIR)/DesignProject -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Derivative -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/Derivative_ert_rtw/Derivative.c $(START_DIR)/Derivative_ert_rtw/Derivative_data.c

MAIN_SRC = $(START_DIR)/Derivative_ert_rtw/ert_main.c
...
OBJS = Derivative.o Derivative_data.o
...
%.o : $(START_DIR)/Derivative_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Derivative_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
