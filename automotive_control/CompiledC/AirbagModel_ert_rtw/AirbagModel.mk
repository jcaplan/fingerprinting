###########################################################################
## Makefile generated for Simulink model 'AirbagModel'. 
## 
## Makefile     : AirbagModel.mk
## Generated on : Sat Apr 04 15:18:13 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AirbagModel
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = AirbagModel_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AirbagModel
...
INCLUDES_BUILDINFO = -I$(START_DIR)/AirbagModel_ert_rtw -I$(START_DIR) -I$(START_DIR)/DesignProject -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=AirbagModel -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/AirbagModel_ert_rtw/AirbagModel.c $(START_DIR)/AirbagModel_ert_rtw/AirbagModel_data.c

MAIN_SRC = $(START_DIR)/AirbagModel_ert_rtw/ert_main.c
...
OBJS = AirbagModel.o AirbagModel_data.o
...
%.o : $(START_DIR)/AirbagModel_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/AirbagModel_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
