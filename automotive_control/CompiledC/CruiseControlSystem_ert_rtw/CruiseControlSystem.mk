###########################################################################
## Makefile generated for Simulink model 'CruiseControlSystem'. 
## 
## Makefile     : CruiseControlSystem.mk
## Generated on : Mon Mar 23 13:31:56 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/CruiseControlSystem
...
PRODUCT_NAME              = CruiseControlSystem
MAKEFILE                  = CruiseControlSystem.mk
COMPUTER                  = MACI64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = CruiseControlSystem_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/CruiseControlSystem
...
INCLUDES_BUILDINFO = -I$(START_DIR)/CruiseControlSystem_ert_rtw -I$(START_DIR) -I$(START_DIR)/DesignProject -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=CruiseControlSystem -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/CruiseControlSystem_ert_rtw/CruiseControlSystem.c $(START_DIR)/CruiseControlSystem_ert_rtw/CruiseControlSystem_data.c

MAIN_SRC = $(START_DIR)/CruiseControlSystem_ert_rtw/ert_main.c
...
OBJS = CruiseControlSystem.o CruiseControlSystem_data.o
...
%.o : $(START_DIR)/CruiseControlSystem_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/CruiseControlSystem_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
